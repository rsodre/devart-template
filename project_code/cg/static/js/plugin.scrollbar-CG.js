...
(function($) {
	$.fn.scrollbar = function(params) {
		...
		params = $.extend( {
			...
			taille_bouton: 120,				//Taille du bouton - /!\ Doit être un nombre
			...
			style: 'cartograffiti',			//Choix des styles - /!\ Par défault, il n'y a que le style 'basic'
			...
			marge_scroll_contenu: 0,		//Marge entre la scrollBar et le contenu - /!\ Doit être un nombre
		...
		return this.each(function() {
			...
			var padBot=0;
			//Hauteur du contenu
            var taille_contenu = tab_content_height;
			...
			function calcul_hauteur_auto(){
				if(params.taille_englobe == "auto"){
						 ...
						 params.taille_englobe = tab_content_visible_height;
				}else{return false}
			}
			calcul_hauteur_auto();
